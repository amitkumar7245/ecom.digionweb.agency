...
<head>
    ...
    <title>Ecommerce Portal | Forgot Password</title>
</head>
<body class="bg-login">
    <!--wrapper-->
    <div class="wrapper">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    @include('_message')
                                    <div class="form-body"> 
                                        <form class="row g-3" method="post" action="{{ route('store.forgot') }}">
                                            @csrf
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button type="submit" class="btn btn-primary"><i class="bx bxs-lock-open"></i>Send</button>
